...
| -------------------- | :--------------------- |:---------------------------| 
| [01. Компьютерное зрение. Детекция пингвинов. YOLOv8.](https://colab.research.google.com/drive/1pbnv7fF-jfJd8XzXfkXxKqzVOpSheIVk?usp=sharing)|CV. Создать модель детекции пингвинов на готовом размеченном датасете.|Завершен|
