...
| [03. Прогнозирование наличия диабета.]()|Проанализировать данные, создать модели классификации для предсказания диабета у пациента и выбрать наилучшую модель.|В процессе|
