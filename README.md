...
| [03. Прогнозирование наличия диабета.](https://nbviewer.org/github/ArtemPlgn/Data_science_projects/blob/main/predict_diab/diab_pred.ipynb)|Проанализировать данные, создать модели классификации для предсказания диабета у пациента и выбрать наилучшую модель.|В процессе|
